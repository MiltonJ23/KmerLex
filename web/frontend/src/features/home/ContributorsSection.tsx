...
// ✅ DONNÉES RÉELLES DU GROUPE MISES À JOUR
const CONTRIBUTORS: Contributor[] = [
  {
    id: "ICTU20233585",
    name: "Zingui Fred Mike",
    role: "Lead Architect & Engine",
    avatarUrl: "https://api.dicebear.com/7.x/avataaars/svg?seed=Yves&backgroundColor=ffdfbf",
    github: "https://github.com/MiltonJ23",
    stack: ["Compiler", "TypeScript", "AST"]
  },
  {
    id: "ICTU20234482",
    name: "Adama Hadidjatou",
    role: "Frontend Engineer",
    avatarUrl: "https://api.dicebear.com/7.x/avataaars/svg?seed=Adama&backgroundColor=c0aede",
    github: "https://github.com/AdamaHadidjatou",
    stack: ["React", "UI/UX", "Framer"]
  },
  {
    id: "ICTU20223002",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="max-w-xl mx-auto text-kmer-white/60 text-sm md:text-base leading-relaxed">
            The ICT University engineering team dedicated to bridging the gap between urban vernaculars and digital intelligence.
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center" // Modifié pour 3 colonnes centrées
        >
            ...
            <motion.div key={dev.id} variants={cardVariants}>
              ...
              >
                ...
                <div className="p-6 pb-0 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-lg font-bold text-white group-hover:text-kmer-neon transition-colors font-mono uppercase tracking-tight">
                    {dev.name}
                  </h3>
                  <p className="text-xs text-kmer-neon/80 tracking-widest uppercase mb-1 mt-1">
                    {dev.role}
                  </p>
                  <span className="text-[10px] text-kmer-white/30 font-mono bg-kmer-white/5 px-2 py-0.5 rounded">
                    {dev.id}
                  </span>
                </div>
